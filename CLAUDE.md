...
- **Aegis (local agentic OS)** — routines are migrating from CCR to a local runtime under `automation/` (see `automation/CLAUDE.md`). Concept: `.claude/local-model-routines.md`; decisions: `decisions/2026-07-07-aegis-local-agentic-os.md`. No direct writes without approval; Jira/Aha writes stay refinement-gated.
